...
export default function AddFamilyTreeScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await familyTreeAPI.create(data);
      
      if (response.success) {
        Alert.alert('Success', 'Family tree entry created successfully', [
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Add Family Entry</Text>
        <View style={{ width: 60 }} />
      </View>
